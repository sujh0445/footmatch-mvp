  ...
  return (
    <section className="mx-auto max-w-3xl space-y-6 py-6">
      <div className="card space-y-4 p-7 sm:p-10">
        ...
        <h1 className="text-3xl font-semibold tracking-tight sm:text-4xl">내 발에 맞는 사이즈 찾기</h1>
        <p className="text-sm text-neutral-600 sm:text-base">실측 발길이와 착화 경험, 비슷한 발의 후기를 바탕으로 더 맞는 신발 사이즈를 찾도록 돕습니다.</p>
